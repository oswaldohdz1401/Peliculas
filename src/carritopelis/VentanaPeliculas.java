...
public class VentanaPeliculas extends javax.swing.JFrame {
    ...
    private double total;   //Declaración de las variables globales que realizarán los cálculos de la cuenta
    private int contadorPeli = 1;
    private ArrayList<Pelicula> lista = new ArrayList<>();
    private DefaultTableModel modelo = new DefaultTableModel(); //Declaración del objeto de tipo DefaultTableModel el cual mediante sus métodos permitirá agregar filas a una tabla.
    ...
    public VentanaPeliculas() {
     ...
     public void conexionBD() {
        ...
        try {
            ...
            String sql = "SELECT codigo_id, peli_nom, actor_nom, genero, precio, peli_exis FROM peliculas ";
            ...
            while (result.next()) {
                ...
                Pelicula pelicula = new Pelicula(id, peli, nombre, genero, precio, peli_exis);
    ...
    public void guardarBD(Pelicula pelicula) {
        ...
        try {
            //System.out.println("" + pelicula.getCodigoBarras() + "', '" + pelicula.getTitulo() + "', '" + pelicula.getActor() + "', '" + pelicula.getGenero() + "', '" + pelicula.getPrecio() + "', '" + pelicula.getPeliculasExistentes());
            Class.forName("org.postgresql.Driver");
            ...
            String sql = "INSERT INTO peliculas (codigo_id, peli_nom, actor_nom, genero, precio, peli_exis) VALUES ('" + pelicula.getCodigoBarras() + "', '" + pelicula.getTitulo() + "', '" + pelicula.getActor() + "', '" + pelicula.getGenero() + "', '" + pelicula.getPrecio() + "', '" + pelicula.getPeliculasExistentes() + "')";
    ...
    private void añadirPeliculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_añadirPeliculaActionPerformed
        ...
        try{
            Pelicula pelicula = new Pelicula(verificaCofigoBarras(), cd.pedirTitulo(), cd.pedirActor(), cd.pedirGenero(), cd.pedirPrecio(),cd.predirPeliculasEnexistencia()); //Se mandan los atributos al constructor de la clase Peliculas para la creación del objeto. 
            lista.add(pelicula);    //Se añade al ArrayList los datos de los atributos del objeto pelicula.
    ...
    private String verificaCofigoBarras(){
        ...
        JOptionPane.showMessageDialog(null,"Codigo de barras ya existente introduce diferente","ERROR",JOptionPane.WARNING_MESSAGE);
    ...
    private void eliminarPeliculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarPeliculaActionPerformed
        ...
        actualizaTablaCatalgo(carritoCompras.getValueAt(peliculaSeleccionada, 0).toString());
        //contadorPeliculas.setText(Integer.toString(contadorPeli--));
        String cantidadPelicula = carritoCompras.getValueAt(peliculaSeleccionada,3).toString();
        ...
        if(cantidadPeliculas > 1 && c >1){
            cantidadPeliculas--;
            carritoCompras.setValueAt(cantidadPeliculas,peliculaSeleccionada,3);    
            precio = carritoCompras.getValueAt(peliculaSeleccionada, 2).toString();
            precioDouble = Double.parseDouble(precio);  //Función que recibe una cadena y regresa una variable de tipo double.
            subTotalPelicula = carritoCompras.getValueAt(peliculaSeleccionada, 4).toString();
            subTotalPeliculaDouble = Double.parseDouble(subTotalPelicula); 
            subTotalPeliculaDouble = subTotalPeliculaDouble - precioDouble;
            carritoCompras.setValueAt(subTotalPeliculaDouble, peliculaSeleccionada, 4);
            ...
            if(cantidadPeliculas == 1){
                ...
                DefaultTableModel modelo = (DefaultTableModel)carritoCompras.getModel(); 
        ...
        System.out.println(""+total);    
            ...
            JOptionPane.showMessageDialog(null, "Selecciona una película del carrito", "Error", JOptionPane.WARNING_MESSAGE);   //Mensaje en caso que no se haya seleccionado alguna fila.
        }   
    ...
    public void actualizaTablaCatalgo(String codigoBarras){
        ...
        for(i=0;i<carritoCompras.getRowCount();i++){
            if(codigoBarras.equals(catalogo.getValueAt(i, 0).toString())){
                 catalogo.setValueAt(Integer.parseInt(catalogo.getValueAt(i, 5).toString())+1,i,5);
            }
        }
    }
    private void agregarPeliculaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarPeliculaActionPerformed
        int contadorPeli = Integer.parseInt(contadorPeliculas.getText().toString()) + 1;
        ...
        String existenciaPelicula = catalogo.getValueAt(peliculaSeleccionada,5).toString();
        ...
        if(peliculaExistenciaInt > 0){
            ...
            codigoBarras = catalogo.getValueAt(peliculaSeleccionada, 0).toString();
            ...
            for(i = 0; i < carritoCompras.getRowCount(); i++){
                if(catalogo.getValueAt(peliculaSeleccionada, 0).toString() == carritoCompras.getValueAt(i,0)){
                    ...
                    carritoCompras.setValueAt((Integer.parseInt(contadorP)+1), i, 3);
            ...
            if(!bandera){
                ...
                String filaelemento[] = {codigoBarras,titulo, precio,"1",precio};
                total = total + subtotal;
                ...
                JOptionPane.showMessageDialog(null, "Selecciona una película del catálogo", "", JOptionPane.WARNING_MESSAGE);
            }
            System.out.println(""+total);
            ...
            JOptionPane.showMessageDialog(null,"Ya no hay en existencia la pelicula seleccionada","No hay peliculas",JOptionPane.WARNING_MESSAGE);
        }
    ...
    public void importarArchivo(){
        ...
        try {
            ...
            String sCadena,codigoBarras,titulo,actorPrincipal,genero,precio,pelExistentes;
            String[] parts;
            while ((sCadena = bf.readLine())!=null) {
                ...
                CapturaDatos cd = new CapturaDatos();
                try{
                    Pelicula pelicula = new Pelicula(codigoBarras,titulo,actorPrincipal,genero,precio,pelExistentes);
                    lista.add(pelicula);
                    construirCatalogo();
                    agregarPelicula.setEnabled(true);
                    btnGuardar.setEnabled(true);
    ...
    public void construirCatalogo() {
        ...
        catalogo.setModel(new javax.swing.table.DefaultTableModel(matriz, new String[]{"Codigo de Barras", "Titulo", "Actor Principal", "Género", "Precio","Peliculas Existentes"}));
    }
